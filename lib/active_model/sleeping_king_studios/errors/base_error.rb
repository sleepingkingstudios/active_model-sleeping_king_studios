# lib/active_model/sleeping_king_studios/errors/base_error.rb

require 'active_model/sleeping_king_studios/errors'

module ActiveModel::SleepingKingStudios::Errors
  # Base class for errors thrown by concerns in the
  # ActiveModel::SleepingKingStudios namespace.
  class BaseError < StandardError
    ...
    def message
      @message ||= ('' << problem_string << summary_string << details_string << resolution_string)
    end # method message
